      ...
      <div class="flex items-center justify-center w-full h-full">
        <div class="flex flex-col">
          <div class="flex items-center">
            ...
            <p class="text-white font-bold text-xl">Follow your interest.</p>
          </div>
          ...
          <div class="flex items-center mt-10">
            ...
            <p class="text-white font-bold text-xl">Join the converstation.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div v-if="showModal === 'step2'">
          <div class="pl-1 pr-4 py-1 h-12">
            <button @click="setSignUpStep('step1')" class="absolute rounded-full p-2 pl-3 hover:bg-lightblue">
              <i class="fas fa-arrow-left text-blue"/>
            </button>
  ...
  methods: {
    ...
    async confirmUserSignUp() {
      try {
        ...
        alert("Error confirming verification code. Please check console")
    ...
    async resendVerificationCode() {
      try {
        ...
        await this.logoutUser()
        alert("Error resending verificaiton code. Please check console")
        console.log('Error resending verificaiton code:', error)
      }
    },
    esc() {
      this.setSignUpStep('')
